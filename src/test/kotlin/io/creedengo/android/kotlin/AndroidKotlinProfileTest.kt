...
class AndroidKotlinProfileTest {
    ...
    fun `profile references only known rule keys`() {
        ...
        assertThat(profileKeys).isEqualTo(setOf("GCI500", "GCI501", "GCI505", "GCI506", "GCI507", "GCI508", "GCI509", "GCI510", "GCI521", "GCI522", "GCI525", "GCI526", "GCI528", "GCI529", "GCI530", "GCI531", "GCI534", "GCI600"))
    }
}
