...
import io.creedengo.android.kotlin.checks.environment.LazyLoadingRule
...
import io.creedengo.android.kotlin.checks.environment.KeepVoiceAwakeRule
import io.creedengo.android.kotlin.checks.environment.LocationLeakRule
...
class CreedengoKotlinExtensionsProvider : KotlinPluginExtensionsProvider {
    ...
    override fun registerKotlinPluginExtensions(extensions: KotlinPluginExtensionsProvider.Extensions) {
        ...
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, LocationLeakRule::class.java, false)
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, SensorManagerLeakRule::class.java, false)
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, CameraLeakRule::class.java, false)
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, KeepVoiceAwakeRule::class.java, false)
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, ThriftyGeolocationCriteriaRule::class.java, false)
        ...
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, BatteryConstrainedWorkRule::class.java, false)
        extensions.registerRule(AndroidKotlinRulesDefinition.REPOSITORY_KEY, LazyLoadingRule::class.java, false)
